...
# NetworkDiag MAX - Maximálisan agresszív LAN diagnosztika
# Cél: semmi se maradjon rejtve (miner-ek, sántító eszközök, lassú válaszok stb.)
...
Write-Log "Cél: semmi se maradjon rejtve (miner, sántító eszköz, lassú válasz, stb.)"
Write-Log ""
...
# ==================== 2. ARP / NEIGHBOR (erősített) ====================
Write-Log ""
Write-Log "=== 2. ARP TÁBLA + Get-NetNeighbor (minden állapot) ===" "Cyan"
...
# ==================== 3. PING-SWEEP - AGGRESSZÍV ====================
Write-Log ""
Write-Log "=== 3. AGGRESSZÍV PING-SWEEP (több próbálkozás + hosszabb timeout) ===" "Cyan"
...
foreach ($subnet in $Subnets) {
    Write-Log "Sweep indul: $subnet.0/24 (3 próbálkozás, 2 mp timeout)..." "Yellow"
...
# ==================== 4. RÉSZLETES HOST VIZSGÁLAT (portok + stratum) ====================
Write-Log ""
Write-Log "=== 4. RÉSZLETES HOST VIZSGÁLAT (hostname, MAC, portok, stratum) ===" "Cyan"

# Gyakori + miner/stratum portok
$CommonPorts = @(21, 22, 23, 25, 80, 443, 445, 8080, 8443, 3389, 5900)
$MinerPorts   = @(3333, 3334, 3335, 3336, 4028, 5555, 7777, 9999, 14433, 14444, 45700, 25, 8888, 9998)
...
foreach ($ip in ($AliveHosts | Sort-Object)) {
    ...
    foreach ($port in $AllPorts) {
        try {
            ...
            $success = $iar.AsyncWaitHandle.WaitOne(900, $false)   # 900 ms timeout
            $sw.Stop()
...
# ==================== 5. PATHPING / TRACEROUTE a gyanús IP-kre ====================
Write-Log ""
Write-Log "=== 5. PATHPING / TRACEROUTE (lassú + élő hostok) ===" "Cyan"
...
# ==================== 6. ÚTVONAL + DNS ====================
Write-Log ""
Write-Log "=== 6. ÚTVONAL TÁBLA ÉS DNS ===" "Cyan"
...
# ==================== 7. TCP KAPCSOLATOK ====================
Write-Log ""
Write-Log "=== 7. AKTÍV TCP KAPCSOLATOK ===" "Cyan"
try {
...
# ==================== 8. ADAPTER HIBASTATISZTIKÁK ====================
Write-Log ""
Write-Log "=== 8. ADAPTER HIBASTATISZTIKÁK ===" "Cyan"
try {
...
# ==================== 9. RENDSZERNAPLÓ ====================
Write-Log ""
Write-Log "=== 9. RENDSZERNAPLÓ - HÁLÓZATI HIBÁK (utolsó 72 óra) ===" "Cyan"
...
# ==================== 10. EGYÉB ====================
Write-Log ""
Write-Log "=== 10. EGYÉB INFORMÁCIÓK ===" "Cyan"
